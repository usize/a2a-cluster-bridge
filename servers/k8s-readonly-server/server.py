...
def get_events(namespace: str, field_selector: Optional[str] = None) -> str:
    ...
    try:
        ...
        return f"Found {len(event_list)} event(s) in namespace '{namespace}':\n\n" + \
               str(event_list)
...
def get_deployments(namespace: str) -> str:
    ...
    try:
        ...
        return f"Found {len(deployment_list)} deployment(s) in namespace '{namespace}':\n\n" + \
               str(deployment_list)
...
def get_services(namespace: str) -> str:
    ...
    try:
        ...
        return f"Found {len(service_list)} service(s) in namespace '{namespace}':\n\n" + \
               str(service_list)
